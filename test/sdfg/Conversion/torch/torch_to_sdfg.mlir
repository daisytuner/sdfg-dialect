...
// CHECK: module {
// CHECK:   func.func @main(%arg0: !torch.vtensor<[1,3,224,224],f32>) -> !torch.vtensor<[1,64,55,55],f32> {
...
// CHECK:     %2 = sdfg.library_node "onnx.Conv"
// CHECK:     %3 = sdfg.library_node "onnx.Relu"
// CHECK:     %4 = sdfg.library_node "onnx.MaxPool"
// CHECK:     return %4 : !torch.vtensor<[1,64,55,55],f32>
// CHECK:   }
// CHECK: }
